<template>
    <div class="shadow-md bg-white py-4 px-4 mx-auto lg:w-[550px]">
        <p class="text-lg font-bold my-2 text-center">  Pending Loans</p>

        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-yellow-500">
...
const rejectedLoans = computed(() => {
    return props.loans.filter(loan => loan.status === 'pending');
});
</script>
